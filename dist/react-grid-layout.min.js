(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    exports["ReactGridLayout"] = factory(
      require("react"),
      require("react-dom")
    );
  else root["ReactGridLayout"] = factory(root["React"], root["ReactDOM"]);
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var ReactGridLayout = (function(_React$Component) {
          ...
          ReactGridLayout.prototype.onDragStop = function onDragStop(
            i,
            x,
            y,
            _ref3
          ...
          ReactGridLayout.prototype.onResize = function onResize(
            i,
            w,
            h,
            _ref5
        ...
        ReactGridLayout.propTypes = {
          ...
          containerPadding: _propTypes2.default.arrayOf(
          ...
          return /******/ (function(modules) {
            ...
            /******/ [
              ...
              /***/ function(module, exports, __webpack_require__) {
                ...
                if (
                  Object({ DRAGGABLE_DEBUG: undefined }).NODE_ENV !==
                  "production"
                ) {
              ...
              /***/ function(module, exports, __webpack_require__) {
                ...
                function outerHeight(node /*: HTMLElement*/) /*: number*/ {
                  ...
                  var computedStyle = node.ownerDocument.defaultView.getComputedStyle(
                    node
                  );
              ...
              /***/ function(module, exports, __webpack_require__) {
                ...
                function findDOMNode(
                  draggable /*: Draggable | DraggableCore*/
                ) /*: HTMLElement*/ {
  ...
  onMouseDown: (e: MouseEvent) => void,
                    ...
                    function DraggableCore() {
                      ...
                      return (
                        (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                          this,
                          (_ref =
                            DraggableCore.__proto__ ||
                            Object.getPrototypeOf(DraggableCore)).call.apply(
                            _ref,
                            [this].concat(args)
                          )
                        )),
                        ...
                        (_this.handleDragStart = function(e) {
                          ...
                          var touchIdentifier = (0, _domFns.getTouchIdentifier)(
                            e
                          );
                        ...
                        (_this.handleDrag = function(e) {
                          ...
                          if (Array.isArray(_this.props.grid)) {
                            ...
                            (x = _this.state.lastX + _deltaX),
                              (y = _this.state.lastY + _deltaY);
                          }
                  ...
                  DraggableCore.propTypes = {
                    ...
                    offsetParent: function offsetParent(
                      ...
                      propName /*: $Keys<DraggableCoreProps>*/
                    ) {
                      if (
                     ...
                     */
                    grid: _propTypes2.default.arrayOf(
                      _propTypes2.default.number
                    ),
                ...
                var Draggable = (function(_React$Component) {
                  ...
                  function Draggable(props /*: DraggableProps*/) {
                    ...
                    var _this = _possibleConstructorReturn(
                      this,
                      (
                        Draggable.__proto__ || Object.getPrototypeOf(Draggable)
                      ).call(this, props)
                    );
                    ...
                    _this.onDragStart = function(e, coreData) {
                      ...
                      var shouldStart = _this.props.onStart(
                        e,
                        (0, _positionFns.createDraggableData)(_this, coreData)
                      );
                      ...
                      value: function render() /*: ReactElement<any>*/ {
                        ...
                        var _props = this.props,
                          ...
                          defaultClassNameDragging =
                            _props.defaultClassNameDragging,
                          defaultClassNameDragged =
                            _props.defaultClassNameDragged;

                        var children = _react2.default.Children.only(
                          this.props.children
                        );
...
*/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Resizable = (function(_React$Component) {
          ...
          Resizable.prototype.componentWillReceiveProps = function componentWillReceiveProps(
            nextProps
          ) {
          ...
          Resizable.prototype.lockAspectRatio = function lockAspectRatio(
            width,
            height,
            aspectRatio
          ) {
          ...
          Resizable.prototype.runConstraints = function runConstraints(
            width,
            height
          ) {
          ...
          Resizable.prototype.resizeHandler = function resizeHandler(
            handlerName
          ) {
            var _this2 = this;
            ...
            return function(e, _ref2) {
              ...
              // Axis restrictions
              var canDragX =
                _this2.props.axis === "both" || _this2.props.axis === "x";
              var canDragY =
                _this2.props.axis === "both" || _this2.props.axis === "y";
          ...
          Resizable.prototype.render = function render() {
            ...
            var _props = this.props,
              ...
              p = _objectWithoutProperties(_props, [
                "children",
                "draggableOpts",
                "width",
                "height",
            ...
            // A draggable handle.
            return (0, _cloneElement2.default)(
              children,
              _extends({}, p, {
                className: className,
                children: [
        ...
        Resizable.propTypes = {
          ...
          // Min/max size
          minConstraints: _propTypes2.default.arrayOf(
            _propTypes2.default.number
          ),
          maxConstraints: _propTypes2.default.arrayOf(
            _propTypes2.default.number
          ),
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var GridItem = (function(_React$Component) {
          ...
          GridItem.prototype.calcPosition = function calcPosition(
            x,
            y,
            w,
            h,
            ...
            var out = {
              ...
              top: Math.round(
                (rowHeight + margin[1]) * y + containerPadding[1]
              ),
          ...
          GridItem.prototype.onDragHandler = function onDragHandler(
            handlerName
          ) {
            var _this2 = this;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var ResizableBox = (function(_React$Component) {
              ...
              (_this.onResize = function(e, data) {
                ...
                if (_this.props.onResize) {
                  ...
                  _this.setState(size, function() {
                    return (
                      _this.props.onResize && _this.props.onResize(e, data)
                    );
                  });
                } else {
                  _this.setState(size);
          ...
          ResizableBox.prototype.componentWillReceiveProps = function componentWillReceiveProps(
            nextProps
          ) {
            if (
              nextProps.width !== this.props.width ||
        ...
        var ResponsiveReactGridLayout = (function(_React$Component) {
          ...
          ResponsiveReactGridLayout.prototype.componentWillReceiveProps = function componentWillReceiveProps(
            ...
            if (
              ...
              !(0, _lodash2.default)(nextProps.layouts, this.props.layouts)
            ) {
